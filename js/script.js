...
function changeLanguage() {
  ...
  for (let key in lngArr) {
    ...
    document.getElementsByName("message")[0].placeholder = lngArr["lng-footer-textarea"][hash];
  }
}
changeLanguage();

//Swiper sliders
const skils = new Swiper(".swiper-skills", {
...
const portfolio = new Swiper(".swiper-container", {
  autoplay: {
    delay: 4000,
...
const introText = new HoverText(document.querySelector(".intro__text"));
